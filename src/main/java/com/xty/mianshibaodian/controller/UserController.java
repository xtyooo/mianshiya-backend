...
import com.xty.mianshibaodian.annotation.AuthCheck;
import com.xty.mianshibaodian.common.BaseResponse;
import com.xty.mianshibaodian.common.DeleteRequest;
import com.xty.mianshibaodian.common.ErrorCode;
import com.xty.mianshibaodian.common.ResultUtils;
import com.xty.mianshibaodian.config.WxOpenConfig;
import com.xty.mianshibaodian.constant.UserConstant;
import com.xty.mianshibaodian.exception.BusinessException;
import com.xty.mianshibaodian.exception.ThrowUtils;
import com.xty.mianshibaodian.model.entity.User;
import com.xty.mianshibaodian.service.UserService;
import com.xty.mianshibaodian.service.impl.UserServiceImpl;
import com.xty.mianshibaodian.model.dto.user.UserAddRequest;
import com.xty.mianshibaodian.model.dto.user.UserLoginRequest;
import com.xty.mianshibaodian.model.dto.user.UserQueryRequest;
import com.xty.mianshibaodian.model.dto.user.UserRegisterRequest;
import com.xty.mianshibaodian.model.dto.user.UserUpdateMyRequest;
import com.xty.mianshibaodian.model.dto.user.UserUpdateRequest;
import com.xty.mianshibaodian.model.vo.LoginUserVO;
...
public class UserController {
    ...
    public BaseResponse<Boolean> addSingIn(HttpServletRequest request) {

        User loginUser = userService.getLoginUser(request);

        return ResultUtils.success(userService.addSingIn(loginUser.getId()));
    }
